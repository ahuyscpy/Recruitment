...
namespace BackendApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> FollowCompany(FollowCompanyViewModel listFollow)
        {
            var result = await _userService.FollowCompany(listFollow.UserId, listFollow.CompanyId);
        ...
        [HttpPost("FollowResponse")]
        public async Task<IActionResult> FollowResponse([FromBody] FollowCompanyViewModel listFollow)
        { 
            var result = await _userService.GetFollowCompany(listFollow);
            return Ok(result);
        }

        [HttpPost("UnFollowCompany")]
        public async Task<IActionResult> UnFollowCompany(FollowCompanyViewModel listFollow)
        {
            var result = await _userService.UnFollowCompany(listFollow);
            if (!result.IsSuccessed)
            {
                return BadRequest(result.Message);
            }
